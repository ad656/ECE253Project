...
def haze_line(image):
    ...
    [img_dehazed, trans_refined] = non_local_dehazing(image, A, gamma=1.0)
    return img_dehazed, trans_refined

if __name__ == "__main__":
    image = cv2.imread("./images/haze_morning.jpg")
    img_dehazed, trans_refined = haze_line(image)
